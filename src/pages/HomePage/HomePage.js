            ...
            <section className="home-section">
                <div className='home-container'>
                    ...
                    <p className="home-description">
                        I am an engineering student at <HighlightText link="https://www.insa-lyon.fr/" text="National Institute of Applied Sciences of Lyon (INSA Lyon)" /> and
                        an AI engineer apprentice at <HighlightText link="https://www.slib.com/" text="SLIB" />.
                    ...
                    <div className="home-social-links">
                        ...
                        <a href="https://www.linkedin.com/in/nghia-hieu-hoang/" target='_blank' rel='noreferrer noopener' className="home-social-link">
                            <FaLinkedin />
                        </a>
                        ...
                        <a href="mailto:nghiahieu12@gmail.com" target='_blank' rel='noreferrer noopener' className="home-social-link">
                            <FaEnvelope />
                        </a>
                    </div>
                </div>
